...
public sealed class RedisPersistence : IRedisPersistence
{
    ...
    public async Task Set(string key, string value)
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(RedisPersistence), methodName: nameof(Set));
    ...
    public async Task<string> Get(string key)
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(RedisPersistence), methodName: nameof(Get));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<bool> Delete(string key)
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(RedisPersistence), methodName: nameof(Delete));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
