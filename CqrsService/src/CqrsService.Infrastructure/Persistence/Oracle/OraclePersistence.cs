...
public sealed class OraclePersistence : IOraclePersistence
{
    private readonly OracleDbConnectionProvider _dbConnectionProvider;

    public OraclePersistence(OracleDbConnectionProvider dbConnectionProvider)
    {
    ...
    public async Task<TModel> Create<TModel>(TModel model) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(Create));
    ...
    public async Task<TModel> QuerySingle<TModel>(Expression<Func<TModel, bool>> expression) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(QuerySingle));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<IEnumerable<TModel>> QueryMultiple<TModel>(Expression<Func<TModel, bool>> expression) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(QueryMultiple));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<TModel> Update<TModel>(Expression<Func<TModel, bool>> expression, TModel model) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(Update));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<bool> Delete<TModel>(Expression<Func<TModel, bool>> expression) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(Delete));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task CallProcedure(string procedureName, OracleDynamicParameters procedureParameters)
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(CallProcedure), operationDetail: procedureName);
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<TModel> CallProcedureQuerySingle<TModel>(string procedureName, OracleDynamicParameters procedureParameters) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(CallProcedureQuerySingle), operationDetail: procedureName);
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<IEnumerable<TModel>> CallProcedureQueryMultiple<TModel>(string procedureName, OracleDynamicParameters procedureParameters) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(CallProcedureQueryMultiple), operationDetail: procedureName);
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task ExecuteCommand(string command)
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(ExecuteCommand));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<TModel> ExecuteCommandQuerySingle<TModel>(string command) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(ExecuteCommandQuerySingle));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
    ...
    public async Task<IEnumerable<TModel>> ExecuteCommandQueryMultiple<TModel>(string command) where TModel : class
    {
        ...
        {
            ExceptionHandlerHelpers.HandleException(exception: ex, className: nameof(OraclePersistence), methodName: nameof(ExecuteCommandQueryMultiple));
            ExceptionDispatchInfo.Capture(ex).Throw();
            throw; //to satisfy the compiler
        }
    }
